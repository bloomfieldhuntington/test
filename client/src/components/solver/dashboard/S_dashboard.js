...
import { getCurrentProfile } from '../../../actions/s_profile';
import {logout} from '../../../actions/s_auth';
// components
import CardStandard from '../../layout/CardStandard';
import CardStandardSkill from '../../layout/CardStandardSkill';
// css
import '../../../css/business_dashboard.css'; // Refactor into component
...
const S_dashboard = ({getCurrentProfile, auth: { user }, profile, logout}) => {
    useEffect(() => {
        getCurrentProfile();
    },[])
...
<div className="dashboard-header-content">
    ...
    <div className="dashboard-header-content-left">
        <h1 className="st-h1">Solver Dashboard</h1>
    </div>
    ...
    <ul className="sidenav-list">
        <li className="sidenav-list-item">
            <div className="list-item-container">
                ...
                <a href="./create_project_business.html"><span className="list-item-title">Browse Projects</span></a>
            </div>
        </li>
        <li className="sidenav-list-item">
            <div className="list-item-container">
...
export default connect(mapStateToProps, {getCurrentProfile, logout})(S_dashboard);
